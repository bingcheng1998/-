...
void setup() {
  ...
  caliTable.addColumn("millis");
  caliTable.addColumn(OrgS);
  caliTable.addColumn(realS);
  ...
  //if (Cali2CsvFile.ENABLE)    
  //{ 
    //angleTable.addColumn(OrgS);
...
void keyPressed() {
  if (key ==  's' || key ==  'S') {
    ...
    if (Cali2CsvFile.ENABLE)    
    {
      saveTable(caliTable, "CaliData/"+FileName+".csv", "csv");
    }
    if (Angle2CsvFile.ENABLE)    
    {
    ...
    if (serialCount > 0 || ch == '$') {
      ...
      if (serialCount == 15) {
        ...
        if(orged == false){
          ...
          //println("quatZ2: " + quatZ2.toString());
          println("V 0 =\t"+vecO.toString()+"  \tV 1 =\t"+vecL.toString()+"  ");
          println("Angle_orged = "+ (180-angle1*180/PI) + " byte = "+ (byte(teapotPacket[11])+90));
           CaliRow = caliTable.addRow();
              //println(table.getRowCount());
              //newRow.setString("name", "Lion");
              //newRow.setString("type", "Mammal");
              CaliRow.setString("millis", String.valueOf(millis()));
              CaliRow.setFloat(OrgS,  (180-angle1*180/PI));
              CaliRow.setInt(realS, (byte(teapotPacket[11])+90));
        }
